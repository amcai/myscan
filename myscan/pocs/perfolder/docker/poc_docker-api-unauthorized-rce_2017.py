...
# @Time    : 2020-05-10
# @Author  : caicai
# @File    : poc_docker-api-unauthorized-rce_2017.py
...
class POC():
    def __init__(self, workdata):
        ...
        self.name = "docker-api-unauthorized-rce"
        self.vulmsg = "referer: https://github.com/vulhub/vulhub/tree/master/docker/unauthorized-rce"
