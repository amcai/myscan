...
class Transport_patch(threading.Thread, ClosingContextManager):
    """
    ...
    def load_server_moduli(filename=None):
        ...
        """
        Transport_patch._modulus_pack = ModulusPack()
        ...
        for fn in file_list:
            try:
                Transport_patch._modulus_pack.read_file(fn)
                return True
            except IOError:
                pass
        # none succeeded
        Transport_patch._modulus_pack = None
        return False
...
def patch_banner_timeout():
    paramiko.Transport=Transport_patch